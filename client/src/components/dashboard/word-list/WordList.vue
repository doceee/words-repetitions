<template>
  ...
  />
  <the-button class="my-1 ml-auto mt-1" @click="handleModalOpen('')">
    Dodaj
  </the-button>
  <ul
  ...
  >
    <li
      ...
      :key="id"
      class="flex w-full rounded-t-lg border-b border-gray-200 px-4 py-2 font-normal dark:border-gray-600"
    >
      <span>
        {{ word + ' - ' + translation }}
      </span>
